...
class RsvpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rsvp" do
    assert_difference("Rsvp.count") do
      post rsvps_url, params: { rsvp: { adults: @rsvp.adults, email: @rsvp.email, minors: @rsvp.minors, phone_number: @rsvp.phone_number } }
    end
  ...
  test "should update rsvp" do
    patch rsvp_url(@rsvp), params: { rsvp: { adults: @rsvp.adults, email: @rsvp.email, minors: @rsvp.minors, phone_number: @rsvp.phone_number } }
